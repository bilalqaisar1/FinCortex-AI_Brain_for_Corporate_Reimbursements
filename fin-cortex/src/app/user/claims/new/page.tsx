  ...
  return (
    <div className="flex min-h-[calc(100vh-0px)] w-full">
      ...
      <main className="flex min-h-[100dvh] flex-1 flex-col pt-20 relative overflow-hidden">
        ...
        <div className="absolute top-[-10%] right-[-10%] size-[500px] bg-primary/10 rounded-full blur-[120px] pointer-events-none" />
        <div className="absolute bottom-[-10%] left-[-10%] size-[500px] bg-accent/10 rounded-full blur-[120px] pointer-events-none" />

        <div className="border-b border-subtle glass-effect px-4 md:px-6 py-4 relative z-10">
