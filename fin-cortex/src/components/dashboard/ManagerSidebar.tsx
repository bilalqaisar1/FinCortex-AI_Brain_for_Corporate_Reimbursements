              ...
              <div key={item.href}>
                ...
                >
                  ...
                  <Icon className={cn(
                    ...
                    isItemActive ? "text-purple-400" : "group-hover:scale-110 group-hover:text-[var(--text-primary)]"
                  )} />
      ...
      <div className="p-6 border-t border-[var(--border-subtle)] relative z-10">
        {!collapsed ? (
          <div className="flex flex-col gap-1 items-center justify-center opacity-40">
            ...
            <p className="text-[8px] font-bold text-[var(--text-muted)] uppercase tracking-widest">Management Suite v2.0</p>
          </div>
        ) : (
